...
namespace EMS_Proj.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DeptID,Name,Description,MgrID")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeptID,Name,Description,MgrID")] Department department)
        {
